...
int main()
{
	...
	double eps1,eps2,slw,Sl1,Sl2,Sg1,Sg2,Di,K,DAL,w1,w2,wg,h1,h2,Ts,gamma1,DP,D1,D2,Ds,As,x1, x12, x2, xi, L1, L2, A1, A2, m1, m2, mi, myul, myug, myus, rhol, rhog, rhos, Sgen, dp_s, CA_b_s, st_s, E_Reb_sur, E_Reb_no_sur, SEC1, SEC2, Delta_st, CA_b, g, st, L, rho, myu, beta, hmin, hminp, Re, Rew, PI, f, gl, k, Reb, qf, mf, dp, Tw, d, hv, ro, ri, cp, Tsat, Te, m, P, Pw, hwi, hwo, U, Gw, Twl, aave, bave, Xave, Tave, uave, a, htcw, htc, mtc, Tin, Xin, B, S, C, Mw, hw0, sw0, Cwi;
	double x3, m3, h3, L3, D3, A3, eps3, gamma2;
	double X3[100][100], X2[100][100], X1[100][100] ;
	...
	for(j=1;j<=M;j++){
		...
		for(o=1;o<=O;o++){
		for(i=1;i<=N;i++){
		m1=1.0/double(N+1)*i*mi;
		m2=1.0/double(O+1)*o*mi;
		...
		////////////////////////////////////////////////////////////////
		x3=(xi-gamma1*x1-gamma2*x2)/(1.0-gamma1-gamma2);
	...
	//////////////////////////////// calculation/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		//fout << x1 << ",";
			...
			//p++;
				...
				//p++;
						//with static head
				mnm.setError(p, 32.0*eps1*(L1+h1)*mi*mi*gamma1*gamma1/(pow(D1,6.0)*3.14*3.14*rhog*pow(rhos,5.0/3.0))*(pow(rhos,2.0/3.0)+1.0)*pow(((pow(rhos,2.0/3.0)-1.0)*x1+1.0),2.0)+gl*h1*rhol*((1.0-1.0/(1.0+(1.0-x1)*S/(x1*pow(rhos, 1.0))))+1.0/(1.0+(1.0-x1)*S/(x1*pow(rhos, 1.0)))/rhos) ,32.0*eps2*(L2+h2)*mi*mi*gamma2*gamma2/(pow(D2,6.0)*3.14*3.14*rhog*pow(rhos,5.0/3.0))*(pow(rhos,2.0/3.0)+1.0)*pow(((pow(rhos,2.0/3.0)-1.0)*x2+1.0),2.0)+gl*h2*rhol*((1.0-1.0/(1.0+(1.0-x2)*S/(x2*pow(rhos, 1.0))))+1.0/(1.0+(1.0-x2)*S/(x2*pow(rhos, 1.0)))/rhos));
				p++;
				mnm.setError(p, 32.0*eps1*(L1+h1)*mi*mi*gamma1*gamma1/(pow(D1,6.0)*3.14*3.14*rhog*pow(rhos,5.0/3.0))*(pow(rhos,2.0/3.0)+1.0)*pow(((pow(rhos,2.0/3.0)-1.0)*x1+1.0),2.0)+gl*h1*rhol*((1.0-1.0/(1.0+(1.0-x1)*S/(x1*pow(rhos, 1.0))))+1.0/(1.0+(1.0-x1)*S/(x1*pow(rhos, 1.0)))/rhos) , 32.0*eps3*(L3+h3)*mi*mi*(1.0-gamma1-gamma2)*(1.0-gamma1-gamma2)/(pow(D3,6.0)*3.14*3.14*rhog*pow(rhos,5.0/3.0))*(pow(rhos,2.0/3.0)+1.0)*pow(((pow(rhos,2.0/3.0)-1.0)*(xi-gamma1*x1-gamma2*x2)/(1.0-gamma1-gamma2)+1.0),2.0)+gl*h3*rhol*((1.0-1.0/(1.0+(1.0-(xi-gamma1*x1-gamma2*x2)/(1.0-gamma1-gamma2))*S/((xi-gamma1*x1-gamma2*x2)/(1.0-gamma1-gamma2)*pow(rhos, 1.0))))+1.0/(1.0+(1.0-(xi-gamma1*x1-gamma2*x2)/(1.0-gamma1-gamma2))*S/((xi-gamma1*x1-gamma2*x2)/(1.0-gamma1-gamma2)*pow(rhos, 1.0)))/rhos));
				p++;
		...
		//SEC1=(gamma/rhol*(((1.0-rhos/S)*x1-1.0)/((1.0-1.0/S)*x1-1.0))+(1.0-gamma)/rhol*(((1.0-rhos/S)*(xi/(1.0-gamma)-x1/(1.0/gamma-1.0))-1.0)/((1.0-1.0/S)*(xi/(1.0-gamma)-x1/(1.0/gamma-1.0))-1.0)));						
					...
					//Sgen=mi*mi/Ts*512.0/4.0*(gamma*gamma*(L1+h1)/(3.14*pow(D1,4.0))*((myul/rhol/rhol*(pow(1.0-x1,2.0))/(pow(1.0-1.0/(1.0+(1.0-x1)/(x1*pow(rhos, 2.0/3.0))),3.0)))+myug/rhog*rhog*((pow(x1,2.0))/(pow(1.0/(1.0+(1.0-x1)/(x1*pow(rhos, 2.0/3.0))),3.0))))+(1.0-gamma)*(1.0-gamma)*((L2+h2)/(3.14*pow(D2,4.0))*((myul/rhol/rhol*(pow(1.0-(xi/(1.0-gamma)-x1/(1.0/gamma-1.0)),2.0))/(pow(1.0-1.0/(1.0+(1.0-(xi/(1.0-gamma)-x1/(1.0/gamma-1.0)))/((xi/(1.0-gamma)-x1/(1.0/gamma-1.0))*pow(rhos, 2.0/3.0))),3.0)))+myug/rhog*rhog*((pow((xi/(1.0-gamma)-x1/(1.0/gamma-1.0)),2.0))/(pow(1.0/(1.0+(1.0-(xi/(1.0-gamma)-x1/(1.0/gamma-1.0)))/((xi/(1.0-gamma)-x1/(1.0/gamma-1.0))*pow(rhos, 2.0/3.0))),3.0))))))+mi/Ts*(gl*h1*rhol*((1.0-1.0/(1.0+(1.0-x1)/(x1*pow(rhos, 2.0/3.0))))+1.0/(1.0+(1.0-x1)/(x1*pow(rhos, 2.0/3.0)))/rhos)*(gamma/(rhol*(1.0-1.0/(1.0+(1.0-x1)/(x1*pow(rhos, 2.0/3.0))))+rhog*1.0/(1.0+(1.0-x1)/(x1*pow(rhos, 2.0/3.0)))))+gl*rhol*h2*((1.0-1.0/(1.0+(1.0-(xi/(1.0-gamma)-x1/(1.0/gamma-1.0)))/((xi/(1.0-gamma)-x1/(1.0/gamma-1.0))*pow(rhos, 2.0/3.0))))+1.0/(1.0+(1.0-(xi/(1.0-gamma)-x1/(1.0/gamma-1.0)))/((xi/(1.0-gamma)-x1/(1.0/gamma-1.0))*pow(rhos, 2.0/3.0)))/rhos)*(gamma/(rhol*(1.0-1.0/(1.0+(1.0-(xi/(1.0-gamma)-x1/(1.0/gamma-1.0)))/((xi/(1.0-gamma)-x1/(1.0/gamma-1.0))*pow(rhos, 2.0/3.0))))+rhog*1.0/(1.0+(1.0-(xi/(1.0-gamma)-x1/(1.0/gamma-1.0)))/((xi/(1.0-gamma)-x1/(1.0/gamma-1.0))*pow(rhos, 2.0/3.0))))));
                       ...
                       // DP=32.0*eps1*(L1+h1)*mi*mi*gamma*gamma/(pow(D1,6.0)*3.14*3.14*rhog*pow(rhos,5.0/3.0))*(pow(rhos,2.0/3.0)+1.0)*pow(((pow(rhos,2.0/3.0)-1.0)*x1+1.0),2.0);
						...
						//with static head
						Sgen=mi/Ts*(gamma1/(rhol*((1.0-1.0/(1.0+(1.0-x1)*S/(x1*pow(rhos, 1.0))))+1.0/(1.0+(1.0-x1)*S/(x1*pow(rhos, 1.0)))/rhos) )+gamma2/(rhol*((1.0-1.0/(1.0+(1.0-x2)*S/(x2*pow(rhos, 1.0))))+1.0/(1.0+(1.0-x2)*S/(x2*pow(rhos, 1.0)))/rhos) )+(1.0-gamma1-gamma2)/(rhol*((1.0-1.0/(1.0+(1.0-(xi-gamma1*x1-gamma2*x2)/(1.0-gamma1-gamma2))*S/((xi-gamma1*x1-gamma2*x2)/(1.0-gamma1-gamma2)*pow(rhos, 1.0))))+1.0/(1.0+(1.0-(xi-gamma1*x1-gamma2*x2)/(1.0-gamma1-gamma2))*S/((xi-gamma1*x1-gamma2*x2)/(1.0-gamma1-gamma2)*pow(rhos, 1.0)))/rhos) ))*(32.0*eps1*(L1+h1)*mi*mi*gamma1*gamma1/(pow(D1,6.0)*3.14*3.14*rhog*pow(rhos,5.0/3.0))*(pow(rhos,2.0/3.0)+1.0)*pow(((pow(rhos,2.0/3.0)-1.0)*x1+1.0),2.0)+gl*h1*rhol*((1.0-1.0/(1.0+(1.0-x1)*S/(x1*pow(rhos, 1.0))))+1.0/(1.0+(1.0-x1)*S/(x1*pow(rhos, 1.0)))/rhos));
						DP=32.0*eps1*(L1+h1)*mi*mi*gamma1*gamma1/(pow(D1,6.0)*3.14*3.14*rhog*pow(rhos,5.0/3.0))*(pow(rhos,2.0/3.0)+1.0)*pow(((pow(rhos,2.0/3.0)-1.0)*x1+1.0),2.0)+gl*h1*rhol*((1.0-1.0/(1.0+(1.0-x1)*S/(x1*pow(rhos, 1.0))))+1.0/(1.0+(1.0-x1)*S/(x1*pow(rhos, 1.0)))/rhos);
						x3=(xi-gamma1*x1-gamma2*x2)/(1.0-gamma1-gamma2);
